...
function preload () {
    ...
    game.load.spritesheet('return', '../games/assets/return.png', 90, 60, 2);//NEW
...
function create () {
    ...
    this.return = game.add.button(15,20,'return',function(){
        window.location.href = '../games/index.html';
    },this,1,0,1);
    this.return.input.priorityID = 5;
    this.return.scale.setTo(spriteScale);
}
