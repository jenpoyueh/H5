...
game.State.load={
    preload:function(){
        ...
        game.load.image('pointBoard1', '/games/games009/assets/pointBoard1.png');
        game.load.image('pointBoard2', '/games/games009/assets/pointBoard2.png');
        game.load.image('NoOK', '/games/games009/assets/NoOK.png');
        ...
        game.load.image('bossIcon', '/games/games009/assets/bossIcon.png');
        ...
        game.load.image('bossDie', '/games/games009/assets/bossDie.png');
        game.load.image('win', '/games/games009/assets/win.png');
        game.load.image('lose', '/games/games009/assets/lose.png');
        game.load.image('endBoard', '/games/games009/assets/endBoard.png');
        game.load.image('endInfo', '/games/games009/assets/endInfo.png');
        game.load.image('badEnd1', '/games/games009/assets/badEnd1.png');
        game.load.image('badEnd2', '/games/games009/assets/badEnd2.png');
        game.load.spritesheet('startbutton', '/games/games009/assets/startbutton.png', 100, 100, 2);
        game.load.spritesheet('boss', '/games/games009/assets/boss.png', 230, 280, 6);
        game.load.spritesheet('skip', '/games/games009/assets/skip.png', 100, 50, 2);
        game.load.spritesheet('warning', '/games/games009/assets/warning.png', 160, 80, 2);
        ...
        game.load.spritesheet('BarDownB', '/games/games009/assets/BarDownB.png', 26, 90, 10);
        game.load.spritesheet('BarUpB', '/games/games009/assets/BarUpB.png', 26, 90, 10);
        game.load.spritesheet('OK', '/games/games009/assets/OK.png', 70, 40, 2);
        game.load.spritesheet('cancel', '/games/games009/assets/cancel.png', 30, 30, 2);
        game.load.audio('bgm', '/games/games009/assets/bgm.mp3');
        game.load.audio('hit', '/games/games009/assets/hit.mp3');
        game.load.audio('readyGo', '/games/games009/assets/readyGo.mp3');
        ...
        game.load.audio('siren', '/games/games009/assets/siren.mp3');
        game.load.audio('gameOver', '/games/games009/assets/gameOver.mp3');
        game.load.audio('trueEnd', '/games/games009/assets/trueEnd.mp3');
        game.load.audio('victory', '/games/games009/assets/victory.mp3');
        game.load.audio('lose', '/games/games009/assets/lose.mp3');
        game.load.audio('bossBGM', '/games/games009/assets/bossBGM.mp3');
        game.load.audio('ufo', '/games/games009/assets/ufo.mp3');
        game.load.audio('iceDie', '/games/games009/assets/iceDie.mp3');
        game.load.audio('fireDie', '/games/games009/assets/fireDie.mp3');
        game.load.audio('enter', '/games/games009/assets/enter.mp3');
        game.load.audio('cancel', '/games/games009/assets/cancel.mp3');
        // 用來預讀字型
